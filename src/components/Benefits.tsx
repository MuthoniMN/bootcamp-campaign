...
export default function Benefits(){
  return (
    <section className="w-full flex flex-col lg:flex-row gap-8 justify-center items-center py-12 px-4 md:px-8">
    <div>
    ...
    <div className="w-full lg:w-[45%]">
      ...
      <div className="space-y-4 pt-6">
        <div className="flex gap-4 items-center">
          <p className="p-2 text-center text-white bg-[#410372] rounded-[50%] flex items-center justify-center"> <GiGraduateCap className="text-3xl" /> </p>
          <div>
        ...
        <div className="flex gap-4 items-center">
          <p className="text-center text-white bg-[#410372] rounded-[50%] flex items-center justify-center p-2"><HiOutlineBookOpen className="text-2xl" /></p>
          <div>
        ...
        <div className="flex gap-4 items-center">
          <p className="p-2 text-center text-white bg-[#410372] rounded-[50%] flex items-center justify-center"><FaUser className="text-2xl" /></p>
          <div>
        ...
        <div className="flex gap-4 items-center">
          <p className="p-2 text-center text-white bg-[#410372] rounded-full flex items-center justify-center"><FaPlay className="text-3xl" /></p>
          <div>

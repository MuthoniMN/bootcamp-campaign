    ...
    <section className="flex flex-col gap-12 md:gap-0 md:flex-row items-center w-full md:h-[80vh] px-8 py-4">
      <div className="w-full md:w-1/2 h-full flex flex-col gap-6 justify-center">
        ...
        <div className="flex gap-4">
          <button className="px-4 py-2 bg-[#440476] text-white transition-all hover:font-bold rounded-md cursor-pointer">
          <NavLink to="/register">Enroll Now</NavLink>
          </button>
          <button className="px-4 py-2 border-2 border-[#440476] text-[#410372] transition-all hover:font-bold rounded-md cursor-pointer">
